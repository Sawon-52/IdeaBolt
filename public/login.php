  ...
  <body class="roboto">
    ...
    <section class="bg-gray-800 text-white">
      <div class="relative max-w-screen-xl mx-auto min-h-[200px] flex flex-col justify-center items-center">
        <p class="absolute top-2 left-0 py-3 text-gray-300">Home <i class="fa-solid fa-angle-right mx-2"></i> Login</p>

        <div class="text-center max-w-4xl">
          <h1 class="text-4xl md:text-6xl font-semibold mb-5">Login</h1>
        </div>
      </div>
    </section>
