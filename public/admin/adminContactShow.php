        ...
        <div class="flex flex-col md:flex-row min-h-screen max-w-screen-xl mx-auto">
          ...
          <aside class="relative w-full md:w-64 bg-gray-800 p-5 hidden lg:block  text-white" id="panel_sidebar"> 
            ...
            <ul>
              ...
              <li class="mb-2"><a href="<?php echo BASE_URL; ?>public/admin/adminContactShow.php" class="block p-2  bg-orange-500 rounded-sm hover:bg-orange-500">Contact Info</a></li>
          ...
          <div class="flex-1 flex flex-col">
            ...
            <main class="p-6 h-[550px] overflow-y-auto overflow-x-auto " >
              <h2 class="text-2xl font-semibold mb-4"> Manage Contacts & Queries</h2>
              <div >
                <table class="table">
                  <!-- head -->
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Recusandae vitae, nisi quisquam necessitatibus atque minima quae expedita dolorem ullam! Voluptatibus.</p>
                      </td>
