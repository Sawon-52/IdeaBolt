...
include  "../../processes/fetch_personalData.php";
include  "../../processes/update_personal_profile.php";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="flex flex-col md:flex-row min-h-screen max-w-screen-xl mx-auto">
          ...
          <aside class="relative w-full md:w-64 bg-gray-800 p-5 hidden lg:block  text-white" id="panel_sidebar"> 
            ...
            <ul>
              ...
              <li class="mb-2"><a href="<?php echo BASE_URL; ?>public/admin/adminProfileBoard.php" class="block p-2 bg-orange-500 rounded-sm hover:bg-orange-500">Profile</a></li>
