                    ...
                    <tr>
                      ...
                      <th>
                        <div>
                          ...
                          <a href="<?php echo BASE_URL; ?>public/admin/adminUserEdit.php?edit_id=<?php echo $user['id']; ?>">
            ...
            <form method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div class="mb-6 relative">
                    ...
                    <button type="button" id="showButton" type="button" class="absolute right-3 top-10 " >
                      <i class="fa-solid fa-eye" ></i>
                    </button>
                    <button type="button" id="hideButton" class="absolute right-3 top-10  hidden " type="button">
                      <i class="fa-solid fa-eye-slash" ></i>
                    </button>
                  </div>
                </div>
