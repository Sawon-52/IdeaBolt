...
session_start();
 ...
 include __DIR__ . "/../../processes/create_blog.php";
        ...
        <div class="relative flex flex-col md:flex-row min-h-screen max-w-screen-xl mx-auto">
          ...
          <div class="flex-1 flex flex-col">
            ...
            <div class="container mx-auto p-4">
              <h1 class="text-3xl font-bold text-center mb-8">Create a New Blog Post</h1>
              <form  method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <div class="mb-4">
                      ...
                      <input type="text" id="title" name="title" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                  </div>

                  <!-- Slug -->
                  <div class="mb-4">
                      <label for="slug" class="block text-gray-700 font-bold mb-2">Slug</label>
                      <input type="text" id="slug" name="slug" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                  </div>

                  <!-- Description -->
                  <div class="mb-4">
                      <label for="description" class="block text-gray-700 font-bold mb-2">Description</label>
                      <textarea id="description" name="description" rows="3" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                  </div>

                  <!-- Content -->
                  <div class="mb-4">
                      <label for="content" class="block text-gray-700 font-bold mb-2">Content</label>
                      <textarea id="content" name="content" rows="10" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                  </div>
                  ...
                  <div class="mb-4">
                      ...
                      <input type="file" id="featured_image" name="featured_image" value="" accept="image/*" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                  </div>
