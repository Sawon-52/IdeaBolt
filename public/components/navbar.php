        ...
        <div class="navbar text-white py-3">
            ...
            <?php if (isset($_SESSION["user_id"])): ?>
                <?php if ($_SESSION["user_role"] === "admin"): ?>
                    ...
                    <a href="./admin/adminPanel.php" class="btn bg-orange-500 text-white text-xl"><?php echo htmlspecialchars($_SESSION["user_name"]); ?></a>
                </div>
                <?php else: ?>
                    <div class="navbar-end">
                    <a href="./userPanel.php" class="btn bg-orange-500 text-white text-xl"><?php echo htmlspecialchars($_SESSION["user_name"]); ?></a>
                </div>
                <?php endif; ?>
            ...
            <?php else: ?>
                ...
                <div class="navbar-end">
                    <a href="./login.php" class="btn bg-orange-500 text-white text-xl">login</a>
                </div>
            <?php endif; ?>
